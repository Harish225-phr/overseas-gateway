      ...
      <div className="container">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            <div
              key={s.title}
              className="group relative bg-card rounded-2xl p-7 border border-border hover:border-accent shadow-soft hover:shadow-elegant transition-bounce hover:-translate-y-2 animate-fade-in-up"
